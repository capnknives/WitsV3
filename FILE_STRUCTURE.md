...
| `var/` | **Runtime data** (gitignored): `data/`, `documents/`, `exports/`, `logs/`, `workspace/`, `cache/` |
| `documents/` | *(legacy)* — migrated to `var/documents/` on first startup |
| `workspace/` | *(legacy)* — migrated to `var/workspace/` |
| `data/` | *(legacy)* — migrated to `var/data/`; templates tracked in `var/data/` |
| `exports/` | *(legacy)* — migrated to `var/exports/` |
| `logs/` | *(legacy)* — migrated to `var/logs/` |
