...
class DynamicModuleLoader:
    ...
    def __init__(self, config: WitsV3Config):
        ...
        self.module_registry = {
            "base": {
                "size": 2e9,
                "path": os.path.join(self.settings.module_dir, "base_module.safetensors"),
            },
            "python": {
                "size": 2.5e9,
                "path": os.path.join(self.settings.module_dir, "python_expert.safetensors"),
            },
            "creative": {
                "size": 2.2e9,
                "path": os.path.join(self.settings.module_dir, "creative_expert.safetensors"),
            },
            "math": {
                "size": 2.8e9,
                "path": os.path.join(self.settings.module_dir, "math_expert.safetensors"),
            },
            "chat": {
                "size": 1.8e9,
                "path": os.path.join(self.settings.module_dir, "chat_expert.safetensors"),
            },
        }
