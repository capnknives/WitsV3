...
**Always check** [`docs/roadmap/suggested-features-2026-07.md`](docs/roadmap/suggested-features-2026-07.md) for priorities (root `TASK.md` is a redirect only). Product overview: [`README.md`](README.md).
...
4. **Update the forward roadmap** - `docs/roadmap/suggested-features-2026-07.md` (not root `TASK.md`)
...
1. Read `docs/roadmap/suggested-features-2026-07.md` for priorities
...
2. Update `docs/roadmap/suggested-features-2026-07.md` if status changed
...
See **`docs/roadmap/suggested-features-2026-07.md`**. July revival features (Web UI, Document RAG, search, MCP discovery, coding/self-repair, synthesis guard) are shipped. Default next work is polish: remaining test failures, clutter cleanup, CI lint expansion — **not** “Phase 2 Neural Web as primary product.”
