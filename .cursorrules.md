...
- **Always read `planning/architecture/system-architecture.md`** (and `planning/roadmap/revival-2026-07.md` for current status) at the start of new conversations to understand WitsV3's LLM wrapper architecture and goals
