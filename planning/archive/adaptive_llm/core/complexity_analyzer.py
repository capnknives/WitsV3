...
class ComplexityAnalyzer:
    ...
    async def _determine_domain(self, text: str, embedding: list[float] | None) -> str:
        """
        ...
        if any(
            kw in text_lower for kw in ["math", "calculate", "equation", "formula", "computation"]
        ):
            return "math"
        ...
        if any(
            kw in text_lower for kw in ["hello", "hi", "hey", "how are you", "what is your name"]
        ):
            return "chat"
