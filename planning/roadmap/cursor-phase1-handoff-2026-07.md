...
**Update (July 8, 2026 evening):** Phase 0 complete — `fix/revive-2026-07` promoted to **`main`**. Chat slash-command picker shipped (`2709f8d` + null-guard fix). Phase 2.1 is next.
