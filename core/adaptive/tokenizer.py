...
class AdaptiveTokenizer:
    ...
    async def tokenize(self, text: str, max_length: int | None = None) -> torch.Tensor:
        """
    ...
    async def batch_tokenize(self, texts: list[str], max_length: int | None = None) -> torch.Tensor:
        """
